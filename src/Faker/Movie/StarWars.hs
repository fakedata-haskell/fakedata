...
$(generateFakeFields "starWars" ["alternate_character_spellings","admiral_ackbar"])

$(generateFakeFields "starWars" ["alternate_character_spellings","ahsoka_tano"])

$(generateFakeFields "starWars" ["alternate_character_spellings","anakin_skywalker"])

$(generateFakeFields "starWars" ["alternate_character_spellings","asajj_ventress"])
...
$(generateFakeFields "starWars" ["alternate_character_spellings","darth_caedus"])

$(generateFakeFields "starWars" ["alternate_character_spellings","darth_vader"])

$(generateFakeFields "starWars" ["alternate_character_spellings","emperor_palpatine"])
...
$(generateFakeFields "starWars" ["alternate_character_spellings","grand_admiral_thrawn"])

$(generateFakeFields "starWars" ["alternate_character_spellings","grand_moff_tarkin"])
...
$(generateFakeFields "starWars" ["alternate_character_spellings","jabba_the_hutt"])

$(generateFakeFields "starWars" ["alternate_character_spellings","jar_jar_binks"])
...
$(generateFakeFields "starWars" ["alternate_character_spellings","lando_calrissian"])

$(generateFakeFields "starWars" ["alternate_character_spellings","leia_organa"])

$(generateFakeFields "starWars" ["alternate_character_spellings","luke_skywalker"])
...
$(generateFakeFields "starWars" ["alternate_character_spellings","obi_wan_kenobi"])

$(generateFakeFields "starWars" ["alternate_character_spellings","padme_amidala"])

$(generateFakeFields "starWars" ["alternate_character_spellings","qui_gon_jinn"])

$(generateFakeFields "starWars" ["alternate_character_spellings","rey"])

$(generateFakeFields "starWars" ["alternate_character_spellings","shmi_skywalker"])
