...
resolveNameField settings field@"first_name" = case (getLocale settings) `elem` ["id"] of
                                                 True -> do
                                                 ...
                                                 False -> cachedRandomUnresolvedVec "name" field nameFirstNameProvider resolveNameText settings
